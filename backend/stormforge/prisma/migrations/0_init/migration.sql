...
CREATE TABLE "Organization" (
    ...
    "imapEmail" TEXT,
    "imapPassword" TEXT,
    "imapHost" TEXT DEFAULT 'imap.gmail.com',
...
-- CreateIndex
CREATE UNIQUE INDEX "Organization_inboundEmail_key" ON "Organization"("inboundEmail");
...
-- AddForeignKey
ALTER TABLE "CannedResponse" ADD CONSTRAINT "CannedResponse_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
